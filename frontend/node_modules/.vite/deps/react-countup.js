    ...
    CountUp = function() {
      function t(t2, i, n) {
        ...
        this.endVal = i, this.options = n, this.version = "2.4.2", this.defaults = { startVal: 0, decimalPlaces: 0, duration: 2, useEasing: true, useGrouping: true, useIndianSeparators: false, smartEasingThreshold: 999, smartEasingAmount: 333, separator: ",", decimal: ".", prefix: "", suffix: "", enableScrollSpy: false, scrollSpyDelay: 200, scrollSpyOnce: false }, this.finalEndVal = null, this.useEasing = true, this.countDown = false, this.error = "", this.startVal = 0, this.paused = true, this.once = false, this.count = function(t3) {
          ...
          s.frameVal = n2 ? s.endVal : s.frameVal, s.frameVal = Number(s.frameVal.toFixed(s.options.decimalPlaces)), s.printValue(s.frameVal), i2 < s.duration ? s.rAF = requestAnimationFrame(s.count) : null !== s.finalEndVal ? s.update(s.finalEndVal) : s.callback && s.callback();
        }, this.formatNumber = function(t3) {
          var i2, n2, a, e, r = t3 < 0 ? "-" : "";
          i2 = Math.abs(t3).toFixed(s.options.decimalPlaces);
          var o = (i2 += "").split(".");
          if (n2 = o[0], a = o.length > 1 ? s.options.decimal + o[1] : "", s.options.useGrouping) {
            e = "";
          ...
          return s.options.numerals && s.options.numerals.length && (n2 = n2.replace(/[0-9]/g, function(t4) {
            ...
            return s.options.numerals[+t4];
          })), r + s.options.prefix + n2 + a + s.options.suffix;
