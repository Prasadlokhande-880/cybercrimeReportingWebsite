...
function _render(props, slot = {}, tag, name) {
  ...
  if (Component === import_react13.Fragment) {
    if (Object.keys(compact(rest)).length > 0) {
      ...
      return (0, import_react13.cloneElement)(resolvedChildren, Object.assign({}, mergeProps(resolvedChildren.props, compact(omit(rest, ["ref"]))), dataAttributes, refRelatedProps, mergeRefs(resolvedChildren.ref, refRelatedProps.ref), classNameProps));
    }
  }
...
function adjustOrderedState(state, adjustment = (i) => i) {
  ...
  let sortedOptions = sortByDomNode(adjustment(state.options.slice()), (option) => option.dataRef.current.domRef.current);
...
function ComboboxFn(props, ref) {
  ...
  let data = (0, import_react18.useMemo)(() => ({
    ...
    get activeOptionIndex() {
      if (defaultToFirstOption.current && state.activeOptionIndex === null && state.options.length > 0) {
        let localActiveOptionIndex = state.options.findIndex((option) => !option.dataRef.current.disabled);
        if (localActiveOptionIndex !== -1) {
  ...
  let lastActiveOption = (0, import_react18.useRef)(data.activeOptionIndex !== null ? data.options[data.activeOptionIndex] : null);
...
function contains(containers, element) {
  ...
  for (let container of containers) {
    if ((_a3 = container.current) == null ? void 0 : _a3.contains(element))
      return true;
  }
  return false;
}
...
var DialogRoot = forwardRefWithAs(function Dialog(props, ref) {
  ...
  let resolveContainers = useEvent(() => {
    var _a3, _b;
    let rootContainers = Array.from((_a3 = ownerDocument == null ? void 0 : ownerDocument.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? _a3 : []).filter((container) => {
  ...
  let contextBag = (0, import_react29.useMemo)(() => [{ dialogState, close, setTitleId }, state], [dialogState, state, close, setTitleId]);
...
var _a2;
var startTransition = (_a2 = import_react30.default.startTransition) != null ? _a2 : function startTransition2(cb) {
  cb();
};
...
var DisclosureRoot = forwardRefWithAs(function Disclosure(props, ref) {
  ...
  }, props.as === void 0 || props.as === import_react31.Fragment));
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: disclosureState === 0 /* Open */, close }), [disclosureState, close]);
  let ourProps = {
    ref: disclosureRef
  };
  return /* @__PURE__ */ import_react31.default.createElement(DisclosureContext.Provider, {
    value: reducerBag
  }, /* @__PURE__ */ import_react31.default.createElement(DisclosureAPIContext.Provider, {
    value: api
...
var Button3 = forwardRefWithAs(function Button4(props, ref) {
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: state.disclosureState === 0 /* Open */ }), [state]);
...
var Panel3 = forwardRefWithAs(function Panel4(props, ref) {
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: state.disclosureState === 0 /* Open */, close }), [state, close]);
  let ourProps = {
    ref: panelRef,
    id
  };
  return /* @__PURE__ */ import_react31.default.createElement(DisclosurePanelContext.Provider, {
    value: state.panelId
  }, render({
    ourProps,
    theirProps,
...
var ListboxRoot = forwardRefWithAs(function Listbox(props, ref) {
  ...
  let isSelected = (0, import_react32.useCallback)((compareValue) => match(data.mode, {
    [1 /* Multi */]: () => value.some((option) => compare(option, compareValue)),
    [0 /* Single */]: () => compare(value, compareValue)
  }), [value]);
  ...
  let slot = (0, import_react32.useMemo)(() => ({ open: data.listboxState === 0 /* Open */, disabled, value }), [data, disabled, value]);
  let selectOption = useEvent((id) => {
    let option = data.options.find((item) => item.id === id);
    if (!option)
      return;
  ...
  return /* @__PURE__ */ import_react32.default.createElement(ListboxActionsContext.Provider, {
    value: actions
  }, /* @__PURE__ */ import_react32.default.createElement(ListboxDataContext.Provider, {
    value: data
  ...
  }, name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2], idx) => /* @__PURE__ */ import_react32.default.createElement(Hidden, {
    features: 4 /* Hidden */,
    ref: idx === 0 ? (element) => {
      var _a3;
      form.current = (_a3 = element == null ? void 0 : element.closest("form")) != null ? _a3 : null;
...
var Label3 = forwardRefWithAs(function Label4(props, ref) {
  ...
  let slot = (0, import_react32.useMemo)(() => ({ open: data.listboxState === 0 /* Open */, disabled: data.disabled }), [data]);
  let ourProps = { ref: labelRef, id, onClick: handleClick };
  return render({
    ourProps,
    theirProps,
...
var Options3 = forwardRefWithAs(function Options4(props, ref) {
  ...
  let slot = (0, import_react32.useMemo)(() => ({ open: data.listboxState === 0 /* Open */ }), [data]);
  let ourProps = {
...
var Option3 = forwardRefWithAs(function Option4(props, ref) {
  ...
  let slot = (0, import_react32.useMemo)(() => ({ active, selected, disabled }), [active, selected, disabled]);
  let ourProps = {
    id,
    ref: optionRef,
    role: "option",
...
var MenuRoot = forwardRefWithAs(function Menu(props, ref) {
  ...
  let slot = (0, import_react33.useMemo)(() => ({ open: menuState === 0 /* Open */, close }), [menuState, close]);
  let theirProps = props;
...
var Button7 = forwardRefWithAs(function Button8(props, ref) {
  ...
  let slot = (0, import_react33.useMemo)(() => ({ open: state.menuState === 0 /* Open */ }), [state]);
  let ourProps = {
    ref: buttonRef,
    id,
  ...
  let handleKeyDown = useEvent((event) => {
    ...
    switch (event.key) {
      ...
      case "Tab" /* Tab */:
        ...
        dispatch({ type: 1 /* CloseMenu */ });
        disposables().nextFrame(() => {
          focusFrom(state.buttonRef.current, event.shiftKey ? 2 /* Previous */ : 4 /* Next */);
        });
        break;
      default:
        if (event.key.length === 1) {
...
var Item = forwardRefWithAs(function Item2(props, ref) {
  ...
  useIsoMorphicEffect(() => {
    ...
    return d.dispose;
  }, [internalItemRef, active, state.menuState, state.activationTrigger, state.activeItemIndex]);
  ...
  let slot = (0, import_react33.useMemo)(() => ({ active, disabled, close }), [active, disabled, close]);
  let ourProps = {
    id,
    ref: itemRef,
    role: "menuitem",
...
var PopoverRoot = forwardRefWithAs(function Popover(props, ref) {
  ...
  let api = (0, import_react34.useMemo)(() => ({ close, isPortalled }), [close, isPortalled]);
  let slot = (0, import_react34.useMemo)(() => ({ open: popoverState === 0 /* Open */, close }), [popoverState, close]);
  let theirProps = props;
  let ourProps = { ref: popoverRef };
  return /* @__PURE__ */ import_react34.default.createElement(PopoverContext.Provider, {
    value: reducerBag
  }, /* @__PURE__ */ import_react34.default.createElement(PopoverAPIContext.Provider, {
    value: api
  }, /* @__PURE__ */ import_react34.default.createElement(OpenClosedProvider, {
...
var Button9 = forwardRefWithAs(function Button10(props, ref) {
  ...
  let handleFocus = useEvent(() => {
    ...
    function run() {
      ...
      if (result === 0 /* Error */) {
        focusIn(getFocusableElements().filter((el2) => el2.dataset.headlessuiFocusGuard !== "true"), match(direction.current, {
          [0 /* Forwards */]: 4 /* Next */,
          [1 /* Backwards */]: 2 /* Previous */
  ...
  return /* @__PURE__ */ import_react34.default.createElement(import_react34.default.Fragment, null, render({
    ...
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ import_react34.default.createElement(Hidden, {
    id: sentinelId,
    features: 2 /* Focusable */,
    "data-headlessui-focus-guard": true,
    as: "button",
...
var Overlay3 = forwardRefWithAs(function Overlay4(props, ref) {
  ...
  let slot = (0, import_react34.useMemo)(() => ({ open: popoverState === 0 /* Open */ }), [popoverState]);
  let ourProps = {
    ref: overlayRef,
    id,
    "aria-hidden": true,
...
var Panel5 = forwardRefWithAs(function Panel6(props, ref) {
  ...
  let slot = (0, import_react34.useMemo)(() => ({ open: state.popoverState === 0 /* Open */, close }), [state, close]);
  let ourProps = {
    ref: panelRef,
    id,
    onKeyDown: handleKeyDown,
  ...
  return /* @__PURE__ */ import_react34.default.createElement(PopoverPanelContext.Provider, {
    value: id
  }, visible && isPortalled && /* @__PURE__ */ import_react34.default.createElement(Hidden, {
...
var Group3 = forwardRefWithAs(function Group4(props, ref) {
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react34.default.createElement(PopoverGroupContext.Provider, {
    value: contextBag
  }, render({
    ourProps,
    theirProps,
...
var LabelContext = (0, import_react36.createContext)(null);
  ...
  return [
    ...
    (0, import_react36.useMemo)(() => {
      return function LabelProvider(props) {
        ...
        let contextBag = (0, import_react36.useMemo)(() => ({ register, slot: props.slot, name: props.name, props: props.props }), [register, props.slot, props.name, props.props]);
        return /* @__PURE__ */ import_react36.default.createElement(LabelContext.Provider, {
          value: contextBag
        }, props.children);
      };
    }, [setLabelIds])
...
var RadioGroupRoot = forwardRefWithAs(function RadioGroup(props, ref) {
  ...
  let firstOption = (0, import_react37.useMemo)(() => options.find((option) => {
    if (option.propsRef.current.disabled)
      return false;
    return true;
  }), [options]);
  let containsCheckedOption = (0, import_react37.useMemo)(() => options.some((option) => compare(option.propsRef.current.value, value)), [options, value]);
  let triggerChange = useEvent((nextValue) => {
    ...
    if (compare(nextValue, value))
      return false;
    let nextOption = (_a3 = options.find((option) => compare(option.propsRef.current.value, nextValue))) == null ? void 0 : _a3.propsRef.current;
  ...
  let radioGroupData = (0, import_react37.useMemo)(() => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }), [value, firstOption, containsCheckedOption, disabled, compare, state]);
  let radioGroupActions = (0, import_react37.useMemo)(() => ({ registerOption, change: triggerChange }), [registerOption, triggerChange]);
  let ourProps = {
    ref: radioGroupRef,
    id,
    role: "radiogroup",
  ...
  }, /* @__PURE__ */ import_react37.default.createElement(RadioGroupActionsContext.Provider, {
    value: radioGroupActions
  }, /* @__PURE__ */ import_react37.default.createElement(RadioGroupDataContext.Provider, {
    value: radioGroupData
  }, name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2], idx) => /* @__PURE__ */ import_react37.default.createElement(Hidden, {
    features: 4 /* Hidden */,
    ref: idx === 0 ? (element) => {
      var _a3;
      form.current = (_a3 = element == null ? void 0 : element.closest("form")) != null ? _a3 : null;
...
var Option5 = forwardRefWithAs(function Option6(props, ref) {
  ...
  useIsoMorphicEffect(() => actions.registerOption({ id, element: internalOptionRef, propsRef }), [id, actions, internalOptionRef, props]);
  let handleClick = useEvent((event) => {
    var _a4;
    if (isDisabledReactIssue7711(event.currentTarget))
      return event.preventDefault();
  ...
  let slot = (0, import_react37.useMemo)(() => ({ checked, disabled: isDisabled, active: hasFlag(2 /* Active */) }), [checked, isDisabled, hasFlag]);
  return /* @__PURE__ */ import_react37.default.createElement(DescriptionProvider, {
    name: "RadioGroup.Description"
  }, /* @__PURE__ */ import_react37.default.createElement(LabelProvider, {
    name: "RadioGroup.Label"
...
function Group5(props) {
  ...
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let context = (0, import_react38.useMemo)(() => ({ switch: switchElement, setSwitch: setSwitchElement, labelledby, describedby }), [switchElement, setSwitchElement, labelledby, describedby]);
  let ourProps = {};
  let theirProps = props;
  return /* @__PURE__ */ import_react38.default.createElement(DescriptionProvider, {
    name: "Switch.Description"
  }, /* @__PURE__ */ import_react38.default.createElement(LabelProvider, {
    name: "Switch.Label",
    props: {
      onClick() {
        if (!switchElement)
  ...
  }, /* @__PURE__ */ import_react38.default.createElement(GroupContext.Provider, {
    value: context
  }, render({
    ourProps,
    theirProps,
...
var SwitchRoot = forwardRefWithAs(function Switch(props, ref) {
  ...
  return /* @__PURE__ */ import_react38.default.createElement(import_react38.default.Fragment, null, name != null && checked && /* @__PURE__ */ import_react38.default.createElement(Hidden, {
    features: 4 /* Hidden */,
    ...compact({
      as: "input",
      type: "checkbox",
...
function StableCollection({ children }) {
  ...
  return /* @__PURE__ */ React22.createElement(StableCollectionContext.Provider, {
    value: collection
  }, children);
}
...
function useStableCollectionKey() {
  var _a3, _b, _c;
  let owner = (_c = (_b = (_a3 = React22.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) == null ? void 0 : _a3.ReactCurrentOwner) == null ? void 0 : _b.current) != null ? _c : null;
  if (!owner)
    return Symbol();
  let indexes = [];
  let fiber = owner;
...
var reducers8 = {
  [0 /* SetSelectedIndex */](state, action) {
    ...
    if (action.index < 0 || action.index > tabs.length - 1) {
...
var Tabs = forwardRefWithAs(function Tabs2(props, ref) {
  ...
  let tabsData = (0, import_react40.useMemo)(() => ({ orientation, activation, ...state }), [orientation, activation, state]);
  ...
  return /* @__PURE__ */ import_react40.default.createElement(StableCollection, null, /* @__PURE__ */ import_react40.default.createElement(TabsActionsContext.Provider, {
    value: tabsActions
  }, /* @__PURE__ */ import_react40.default.createElement(TabsDataContext.Provider, {
    value: tabsData
  }, tabsData.tabs.length <= 0 && /* @__PURE__ */ import_react40.default.createElement(FocusSentinel, {
    onFocus: () => {
      var _a3, _b;
...
var Panel7 = forwardRefWithAs(function Panel8(props, ref) {
  ...
  if (!selected && ((_c = theirProps.unmount) != null ? _c : true) && !((_d = theirProps.static) != null ? _d : false)) {
    return /* @__PURE__ */ import_react40.default.createElement(Hidden, {
      as: "span",
      ...ourProps
    });
  }
...
var TransitionChild = forwardRefWithAs(function TransitionChild2(props, ref) {
  ...
  return /* @__PURE__ */ import_react41.default.createElement(NestingContext.Provider, {
    value: nesting
  }, /* @__PURE__ */ import_react41.default.createElement(OpenClosedProvider, {
    value: match(state, {
...
var TransitionRoot = forwardRefWithAs(function Transition(props, ref) {
  ...
  let transitionBag = (0, import_react41.useMemo)(() => ({ show, appear, initial }), [show, appear, initial]);
  (0, import_react41.useEffect)(() => {
    if (show) {
      setState("visible" /* Visible */);
  ...
  return /* @__PURE__ */ import_react41.default.createElement(NestingContext.Provider, {
    value: nestingBag
  }, /* @__PURE__ */ import_react41.default.createElement(TransitionContext.Provider, {
    value: transitionBag
  }, render({
    ourProps: {
      ...sharedProps,
      as: import_react41.Fragment,
      children: /* @__PURE__ */ import_react41.default.createElement(TransitionChild, {
        ref: transitionRef,
        ...sharedProps,
        ...theirProps
      })
...
var Child = forwardRefWithAs(function Child2(props, ref) {
  ...
  return /* @__PURE__ */ import_react41.default.createElement(import_react41.default.Fragment, null, !hasTransitionContext && hasOpenClosedContext ? /* @__PURE__ */ import_react41.default.createElement(TransitionRoot, {
    ref,
    ...props
  }) : /* @__PURE__ */ import_react41.default.createElement(TransitionChild, {
    ref,
    ...props
  }));
});
