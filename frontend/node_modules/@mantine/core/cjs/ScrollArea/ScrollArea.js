...
const _ScrollArea = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = ScrollArea_styles['default']({ scrollbarSize, offsetScrollbars, scrollbarHovered, hidden: type === "never" }, { name: "ScrollArea", classNames, styles: styles$1, unstyled });
...
const ScrollAreaAutosize = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadProps(__spreadValues({}, others), {
    ref,
    sx: [{ display: "flex", maxHeight }, ...utils.packSx(sx)]
