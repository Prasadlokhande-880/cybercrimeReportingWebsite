...
const Step = React.forwardRef((props, ref) => {
  ...
  const { classes, cx, theme } = Step_styles['default']({ color, iconSize, size, radius, allowStepClick, iconPosition, orientation }, { name: __staticSelector, classNames, styles: styles$1, unstyled });
