...
const Switch = React.forwardRef((props, ref) => {
  ...
  const { classes } = Switch_styles['default']({ size: (ctx == null ? void 0 : ctx.size) || size, color, radius, labelPosition, error: !!error }, { unstyled, styles: styles$1, classNames, name: "Switch" });
