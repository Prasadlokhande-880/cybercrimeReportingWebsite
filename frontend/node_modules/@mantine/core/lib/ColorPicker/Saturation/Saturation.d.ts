...
export declare function Saturation({ value, onChange, onChangeEnd, focusable, __staticSelector, size, color, saturationLabel, classNames, styles, unstyled, }: SaturationProps): JSX.Element;
