      ...
      >
        <div className="bg-white dark:bg-black h-full">
          <div className="flex justify-between items-center px-4 py-3">
            <NavLink to="/second" className="main-logo flex items-center shrink-0">
              <img
            ...
            <ul className="relative font-semibold space-y-0.5 p-4 py-0">
              ...
              <li className="nav-item">
                <ul>
                  ...
                  <li className="nav-item">
                    <NavLink to="/todolist3" className="group">
                      <div className="flex items-center">
                  ...
                  <li className="nav-item">
                    <NavLink to="/Contacts2" className="group">
                      <div className="flex items-center">
                  ...
                  {/* <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'invoice' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('invoice')}>
                                            <div className="flex items-center">
                                                <IconMenuNotes className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('E-filing')}</span>
                                            </div>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'invoice' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <NavLink to="/apps/invoice/list">{t('initial Inp')}</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/invoice/preview">{t('Petitioner Details')}</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/invoice/add">{t('Responder Details')}</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/invoice/edit">{t('Case Details')}</NavLink>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li> */}
              ...
              <li className="menu nav-item">
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu !== "users" ? "rtl:rotate-90 -rotate-90" : ""
                    }
                  >
                    <IconCaretDown />
                  </div>
